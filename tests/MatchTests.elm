...
suite2 =
    describe "Parse"
        ...
        , testParser "aaa [i italic]" ( [ Text "aaa " { begin = 0, end = 3, id = "0.0", index = 0 }, Expr "i" [ Text " italic" { begin = 6, end = 12, id = "0.3", index = 3 } ] { begin = 5, end = 5, id = "0.2", index = 2 } ], [] )
        , testParser "aaa [i bbb [blue ccc] ddd] eee" ( [ Text "aaa " { begin = 0, end = 3, id = "0.0", index = 0 }, Expr "i" [ Text " bbb " { begin = 6, end = 10, id = "0.3", index = 3 }, Expr "blue" [ Text " ccc" { begin = 16, end = 19, id = "0.6", index = 6 } ] { begin = 12, end = 15, id = "0.5", index = 5 }, Text " ddd" { begin = 21, end = 24, id = "0.8", index = 8 } ] { begin = 5, end = 5, id = "0.2", index = 2 }, Text " eee" { begin = 26, end = 29, id = "0.10", index = 10 } ], [] )
        , testParser "math: \\[x^2\\]" ( [ Text "math: " { begin = 0, end = 5, id = "0.0", index = 0 }, Verbatim "math" "x^2" { begin = 6, end = 13, id = "0.1", index = 1 } ], [] )
        ]
