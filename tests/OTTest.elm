...
suite =
    describe "OT test"
        ...
        , test_ "skip 2 chars" (OT.apply [ Skip 2 ] { id = "A", cursor = 0, x = 0, y = 0, content = "abcd" }) { id = "A", cursor = 2, x = 2, y = 0, content = "abcd" }
        ...
        , test_ "Skip 2" (OT.findOps { id = "A", cursor = 0, x = 0, y = 0, content = "abcd" } { id = "A", cursor = 2, x = 0, y = 0, content = "abcd" }) [ Skip 2 ]
        ...
        , test_ "Skip -1" (OT.findOps { id = "A", cursor = 2, x = 2, y = 0, content = "abcd" } { id = "A", cursor = 1, x = 1, y = 0, content = "abcd" }) [ Skip -1 ]
        ...
        , test_ "Delete back 1" (OT.findOps { id = "A", cursor = 2, x = 0, y = 0, content = "abcd" } { id = "A", cursor = 1, x = 0, y = 0, content = "abd" }) [ Skip 0, Delete 1 ]
