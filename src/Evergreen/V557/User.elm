module Evergreen.V557.User exposing (..)
...
type alias User =
    ...
    , created : Time.Posix
    , modified : Time.Posix
    , docs : BoundedDeque.BoundedDeque Evergreen.V557.Document.DocumentInfo
    ...
    , pings : List Evergreen.V557.Chat.Message.ChatMessage
    }
