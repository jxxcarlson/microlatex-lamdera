module Evergreen.V337.Types exposing (..)
...
import Debounce
import Dict
import Evergreen.V337.Abstract
import Evergreen.V337.Authentication
import Evergreen.V337.Compiler.DifferentialParser
import Evergreen.V337.Document
import Evergreen.V337.Parser.Block
import Evergreen.V337.Parser.Language
import Evergreen.V337.Render.Msg
...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V337.Document.Share
...
type FrontendMsg
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V337.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V337.Document.Document
    | LockCurrentDocument
    | UnLockCurrentDocument
    | ShareDocument
    | DoShare
    ...
    | SetDocumentCurrent Evergreen.V337.Document.Document
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V337.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent SystemDocPermissions Evergreen.V337.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent SystemDocPermissions Evergreen.V337.Document.Document
    | SetPublic Evergreen.V337.Document.Document Bool
    | AskForDocumentById String
    | AskForDocumentByAuthorId
    | DeleteDocument
    | SetDeleteDocumentState DocumentDeleteState
    | Render Evergreen.V337.Render.Msg.MarkupMsg
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V337.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , inputSpecial : String
    , userList : List ( Evergreen.V337.User.User, Int )
    , connectedUsers : List String
    , shareDocumentList : List ( String, SharedDocument )
    , userMessage : Maybe UserMessage
    , currentUser : Maybe Evergreen.V337.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V337.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , sourceText : String
    , inputTitle : String
    , editRecord : Evergreen.V337.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V337.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V337.Document.Document
    , currentMasterDocument : Maybe Evergreen.V337.Document.Document
    , documents : List Evergreen.V337.Document.Document
    , publicDocuments : List Evergreen.V337.Document.Document
    , inputSearchKey : String
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V337.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V337.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V337.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V337.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V337.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V337.Document.Document
    | UpdateSharedDocumentDict Evergreen.V337.Document.Document
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById String (Maybe String)
    | GetPublicDocuments SortMode (Maybe String)
    | SaveDocument Evergreen.V337.Document.Document
    | SearchForDocumentsWithAuthorAndKey String
    | SearchForDocuments (Maybe String) String
    | GetDocumentByPublicId String
    | GetDocumentById String
    | CreateDocument (Maybe Evergreen.V337.User.User) Evergreen.V337.Document.Document
    | ApplySpecial Evergreen.V337.User.User String
    | DeleteDocumentBE Evergreen.V337.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V337.Document.Document
    | Tick Time.Posix


type ToFrontend
    = SendBackupData String
    | GotUserList (List ( Evergreen.V337.User.User, Int ))
    ...
    | UserSignedUp Evergreen.V337.User.User
    | GotChatHistory
    ...
    | SendDocument SystemDocPermissions Evergreen.V337.Document.Document
    | ReceivedDocuments (List Evergreen.V337.Document.Document)
    | ReceivedPublicDocuments (List Evergreen.V337.Document.Document)
    | SendMessage Message
    | StatusReport (List String)
    | SetShowEditor Bool
