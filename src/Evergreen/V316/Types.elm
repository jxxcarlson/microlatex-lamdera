...
import Debounce
import Dict
import Evergreen.V316.Abstract
import Evergreen.V316.Authentication
import Evergreen.V316.Compiler.DifferentialParser
import Evergreen.V316.Document
import Evergreen.V316.Parser.Block
import Evergreen.V316.Parser.Language
import Evergreen.V316.Render.Msg
...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V316.Document.Share
...
type FrontendMsg
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V316.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V316.Document.Document
    | LockCurrentDocument
    | UnLockCurrentDocument
    | ShareDocument
    | DoShare
    ...
    | SetDocumentCurrent Evergreen.V316.Document.Document
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V316.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent SystemDocPermissions Evergreen.V316.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent SystemDocPermissions Evergreen.V316.Document.Document
    | SetPublic Evergreen.V316.Document.Document Bool
    | AskForDocumentById String
    | AskForDocumentByAuthorId
    | DeleteDocument
    | SetDeleteDocumentState DocumentDeleteState
    | Render Evergreen.V316.Render.Msg.MarkupMsg
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V316.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , inputSpecial : String
    , userList : List ( Evergreen.V316.User.User, Int )
    , connectedUsers : List String
    , shareDocumentList : List ( String, SharedDocument )
    , userMessage : Maybe UserMessage
    , currentUser : Maybe Evergreen.V316.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V316.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , sourceText : String
    , inputTitle : String
    , editRecord : Evergreen.V316.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V316.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V316.Document.Document
    , currentMasterDocument : Maybe Evergreen.V316.Document.Document
    , documents : List Evergreen.V316.Document.Document
    , publicDocuments : List Evergreen.V316.Document.Document
    , inputSearchKey : String
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V316.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V316.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V316.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V316.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V316.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V316.Document.Document
    | UpdateSharedDocumentDict Evergreen.V316.Document.Document
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById String (Maybe String)
    | GetPublicDocuments SortMode (Maybe String)
    | SaveDocument Evergreen.V316.Document.Document
    | SearchForDocumentsWithAuthorAndKey String
    | SearchForDocuments (Maybe String) String
    | GetDocumentByPublicId String
    | GetDocumentById String
    | CreateDocument (Maybe Evergreen.V316.User.User) Evergreen.V316.Document.Document
    | ApplySpecial Evergreen.V316.User.User String
    | DeleteDocumentBE Evergreen.V316.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V316.Document.Document
    | Tick Time.Posix


type ToFrontend
    = SendBackupData String
    | GotUserList (List ( Evergreen.V316.User.User, Int ))
    ...
    | UserSignedUp Evergreen.V316.User.User
    | GotChatHistory
    ...
    | SendDocument SystemDocPermissions Evergreen.V316.Document.Document
    | ReceivedDocuments (List Evergreen.V316.Document.Document)
    | ReceivedPublicDocuments (List Evergreen.V316.Document.Document)
    | SendMessage Message
    | StatusReport (List String)
    | SetShowEditor Bool
