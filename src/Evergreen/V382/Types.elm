...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V382.Document.Share
...
type FrontendMsg
    ...
    | GotTime Time.Posix
    | Render Evergreen.V382.Render.Msg.MarkupMsg
    | ToggleCheatsheet
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V382.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V382.Document.Document
    | LockCurrentDocument
    ...
    | SetDocumentCurrent Evergreen.V382.Document.Document
    | SetDocumentCurrentViaId Evergreen.V382.Document.DocumentId
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V382.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent DocumentHandling Evergreen.V382.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent DocumentHandling Evergreen.V382.Document.Document
    | SetPublic Evergreen.V382.Document.Document Bool
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V382.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , currentUser : Maybe Evergreen.V382.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V382.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , sourceText : String
    , inputTitle : String
    , editRecord : Evergreen.V382.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V382.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V382.Document.Document
    , currentCheatsheet : Maybe Evergreen.V382.Document.Document
    , currentMasterDocument : Maybe Evergreen.V382.Document.Document
    , documents : List Evergreen.V382.Document.Document
    , publicDocuments : List Evergreen.V382.Document.Document
    , inputSearchKey : String
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V382.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V382.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V382.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V382.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V382.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V382.Document.Document
    | UpdateSharedDocumentDict Evergreen.V382.Document.Document
    | GetCheatSheetDocument
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById DocumentHandling Evergreen.V382.Document.DocumentId
    | GetPublicDocuments SortMode (Maybe String)
    | SaveDocument Evergreen.V382.Document.Document
    ...
    | CreateDocument (Maybe Evergreen.V382.User.User) Evergreen.V382.Document.Document
    | ApplySpecial Evergreen.V382.User.User String
    | DeleteDocumentBE Evergreen.V382.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V382.Document.Document
    | Tick Time.Posix
...
type ToFrontend
    ...
    | UserSignedUp Evergreen.V382.User.User
    | GotChatHistory
    ...
    | ReceivedDocument DocumentHandling Evergreen.V382.Document.Document
    | ReceivedNewDocument DocumentHandling Evergreen.V382.Document.Document
    | ReceivedDocuments (List Evergreen.V382.Document.Document)
    | ReceivedPublicDocuments (List Evergreen.V382.Document.Document)
    | MessageReceived Message
    | StatusReport (List String)
    | SetShowEditor Bool
    | UnlockDocument Evergreen.V382.Document.DocumentId
