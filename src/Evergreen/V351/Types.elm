...
import Debounce
import Dict
import Evergreen.V351.Abstract
import Evergreen.V351.Authentication
import Evergreen.V351.Compiler.DifferentialParser
import Evergreen.V351.Document
import Evergreen.V351.Parser.Block
import Evergreen.V351.Parser.Language
import Evergreen.V351.Render.Msg
...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V351.Document.Share
...
type FrontendMsg
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V351.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V351.Document.Document
    | LockCurrentDocument
    | ShareDocument
    | DoShare
    ...
    | SetDocumentCurrent Evergreen.V351.Document.Document
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V351.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent SystemDocPermissions Evergreen.V351.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent SystemDocPermissions Evergreen.V351.Document.Document
    | SetPublic Evergreen.V351.Document.Document Bool
    | AskForDocumentById String
    | AskForDocumentByAuthorId
    | DeleteDocument
    | SetDeleteDocumentState DocumentDeleteState
    | Render Evergreen.V351.Render.Msg.MarkupMsg
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V351.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , inputSpecial : String
    , userList : List ( Evergreen.V351.User.User, Int )
    , connectedUsers : List String
    , shareDocumentList : List ( String, SharedDocument )
    , userMessage : Maybe UserMessage
    , currentUser : Maybe Evergreen.V351.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V351.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , sourceText : String
    , inputTitle : String
    , editRecord : Evergreen.V351.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V351.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V351.Document.Document
    , currentMasterDocument : Maybe Evergreen.V351.Document.Document
    , documents : List Evergreen.V351.Document.Document
    , publicDocuments : List Evergreen.V351.Document.Document
    , inputSearchKey : String
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V351.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V351.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V351.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V351.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V351.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V351.Document.Document
    | UpdateSharedDocumentDict Evergreen.V351.Document.Document
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById String (Maybe String)
    | GetPublicDocuments SortMode (Maybe String)
    | SaveDocument Evergreen.V351.Document.Document
    | SearchForDocumentsWithAuthorAndKey String
    | SearchForDocuments (Maybe String) String
    | GetDocumentByPublicId String
    | GetDocumentById String
    | CreateDocument (Maybe Evergreen.V351.User.User) Evergreen.V351.Document.Document
    | ApplySpecial Evergreen.V351.User.User String
    | DeleteDocumentBE Evergreen.V351.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V351.Document.Document
    | Tick Time.Posix


type ToFrontend
    = SendBackupData String
    | GotUserList (List ( Evergreen.V351.User.User, Int ))
    ...
    | UserSignedUp Evergreen.V351.User.User
    | GotChatHistory
    ...
    | ReceivedDocument SystemDocPermissions Evergreen.V351.Document.Document
    | ReceivedDocuments (List Evergreen.V351.Document.Document)
    | ReceivedPublicDocuments (List Evergreen.V351.Document.Document)
