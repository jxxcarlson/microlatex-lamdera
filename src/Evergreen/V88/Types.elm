...
type alias FrontendModel =
    ...
    , initialText : String
    , sourceText : String
    , editRecord : Evergreen.V88.Compiler.DifferentialParser.EditRecord
    ...
    , currentMasterDocument : Maybe Evergreen.V88.Document.Document
    ...
    , sortMode : SortMode
    , language : Evergreen.V88.Parser.Language.Language
    }
...
type FrontendMsg
    ...
    | Render Evergreen.V88.Render.Msg.MarkupMsg
...
type ToBackend
    ...
    | ApplySpecial Evergreen.V88.User.User String
