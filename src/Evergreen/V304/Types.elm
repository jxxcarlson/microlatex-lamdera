...
import Debounce
import Dict
import Evergreen.V304.Abstract
import Evergreen.V304.Authentication
import Evergreen.V304.Compiler.DifferentialParser
import Evergreen.V304.Document
import Evergreen.V304.Parser.Block
import Evergreen.V304.Parser.Language
import Evergreen.V304.Render.Msg
...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V304.Document.Share
...
type FrontendMsg
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V304.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V304.Document.Document
    | LockCurrentDocument
    | UnLockCurrentDocument
    | ShareDocument
    | DoShare
    ...
    | SetDocumentCurrent Evergreen.V304.Document.Document
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V304.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent SystemDocPermissions Evergreen.V304.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent SystemDocPermissions Evergreen.V304.Document.Document
    | SetPublic Evergreen.V304.Document.Document Bool
    | AskForDocumentById String
    | AskForDocumentByAuthorId
    | DeleteDocument
    | SetDeleteDocumentState DocumentDeleteState
    | Render Evergreen.V304.Render.Msg.MarkupMsg
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V304.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , inputSpecial : String
    , userList : List ( Evergreen.V304.User.User, Int )
    , connectedUsers : List String
    , shareDocumentList : List ( String, SharedDocument )
    , userMessage : Maybe UserMessage
    , currentUser : Maybe Evergreen.V304.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V304.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , sourceText : String
    , inputTitle : String
    , editRecord : Evergreen.V304.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V304.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V304.Document.Document
    , currentMasterDocument : Maybe Evergreen.V304.Document.Document
    , documents : List Evergreen.V304.Document.Document
    , inputSearchKey : String
    , inputSearchTagsKey : String
    , inputReaders : String
    , inputEditors : String
    ...
    , counter : Int
    , publicDocuments : List Evergreen.V304.Document.Document
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V304.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V304.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V304.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V304.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V304.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V304.Document.Document
    | UpdateSharedDocumentDict Evergreen.V304.Document.Document
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById String (Maybe String)
    | GetPublicDocuments (Maybe String)
    | SaveDocument Evergreen.V304.Document.Document
    | SearchForDocumentsWithAuthorAndKey String
    | GetDocumentByPublicId String
    | GetDocumentById String
    | CreateDocument (Maybe Evergreen.V304.User.User) Evergreen.V304.Document.Document
    | ApplySpecial Evergreen.V304.User.User String
    | SearchForDocuments (Maybe String) String
    | DeleteDocumentBE Evergreen.V304.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V304.Document.Document
    | Tick Time.Posix


type ToFrontend
    = SendBackupData String
    | GotUserList (List ( Evergreen.V304.User.User, Int ))
    ...
    | UserSignedUp Evergreen.V304.User.User
    | GotChatHistory
    ...
    | SendDocument SystemDocPermissions Evergreen.V304.Document.Document
    | ReceivedDocuments (List Evergreen.V304.Document.Document)
    | SendMessage Message
    | StatusReport (List String)
    | SetShowEditor Bool
    | GotPublicDocuments (List Evergreen.V304.Document.Document)
