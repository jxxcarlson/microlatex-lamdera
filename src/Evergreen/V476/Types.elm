module Evergreen.V476.Types exposing (..)
...
import Debounce
import Dict
import Evergreen.V476.Abstract
import Evergreen.V476.Authentication
import Evergreen.V476.Compiler.DifferentialParser
import Evergreen.V476.Document
import Evergreen.V476.Parser.Block
import Evergreen.V476.Parser.Language
import Evergreen.V476.Render.Msg
...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V476.Document.Share
...
type FrontendMsg
    ...
    | GotTime Time.Posix
    | Render Evergreen.V476.Render.Msg.MarkupMsg
    | ToggleCheatsheet
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V476.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V476.Document.Document
    | LockCurrentDocument
    ...
    | SetDocumentStatus Evergreen.V476.Document.DocStatus
    | ChangeLanguage
    | MakeBackup
    | ToggleBackupVisibility
    | SetDocumentCurrent Evergreen.V476.Document.Document
    | SetDocumentCurrentViaId Evergreen.V476.Document.DocumentId
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V476.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent DocumentHandling Evergreen.V476.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent DocumentHandling Evergreen.V476.Document.Document
    | SetPublic Evergreen.V476.Document.Document Bool
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V476.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , currentUser : Maybe Evergreen.V476.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V476.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , showDocTools : Bool
    , showPublicUrl : Bool
    , editRecord : Evergreen.V476.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V476.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V476.Document.Document
    , currentCheatsheet : Maybe Evergreen.V476.Document.Document
    , currentMasterDocument : Maybe Evergreen.V476.Document.Document
    , documents : List Evergreen.V476.Document.Document
    , pinnedDocuments : List Evergreen.V476.Document.DocumentInfo
    , publicDocuments : List Evergreen.V476.Document.Document
    , inputSearchKey : String
    ...
    , sortMode : SortMode
    , language : Evergreen.V476.Parser.Language.Language
    }
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V476.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V476.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V476.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V476.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V476.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V476.Document.Document
    | UpdateSharedDocumentDict Evergreen.V476.Document.Document
    | InsertDocument Evergreen.V476.User.User Evergreen.V476.Document.Document
    | GetCheatSheetDocument
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById DocumentHandling Evergreen.V476.Document.DocumentId
    | FindDocumentByAuthorAndKey DocumentHandling Username String
    | GetPublicDocuments SortMode (Maybe String)
    | SaveDocument Evergreen.V476.Document.Document
    ...
    | CreateDocument (Maybe Evergreen.V476.User.User) Evergreen.V476.Document.Document
    | ApplySpecial Evergreen.V476.User.User String
    | HardDeleteDocumentBE Evergreen.V476.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V476.Document.Document
    | Tick Time.Posix
...
type ToFrontend
    ...
    | UserSignedUp Evergreen.V476.User.User
    | GotChatHistory
    ...
    | ReceivedDocument DocumentHandling Evergreen.V476.Document.Document
    | ReceivedNewDocument DocumentHandling Evergreen.V476.Document.Document
    | ReceivedDocuments DocumentHandling (List Evergreen.V476.Document.Document)
    | ReceivedPublicDocuments (List Evergreen.V476.Document.Document)
    | MessageReceived Message
    | StatusReport (List String)
    | SetShowEditor Bool
    | UnlockDocument Evergreen.V476.Document.DocumentId
