...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V389.Document.Share
...
type FrontendMsg
    ...
    | GotTime Time.Posix
    | Render Evergreen.V389.Render.Msg.MarkupMsg
    | ToggleCheatsheet
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V389.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V389.Document.Document
    | LockCurrentDocument
    ...
    | SetDocumentCurrent Evergreen.V389.Document.Document
    | SetDocumentCurrentViaId Evergreen.V389.Document.DocumentId
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V389.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent DocumentHandling Evergreen.V389.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent DocumentHandling Evergreen.V389.Document.Document
    | SetPublic Evergreen.V389.Document.Document Bool
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V389.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , currentUser : Maybe Evergreen.V389.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V389.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , sourceText : String
    , inputTitle : String
    , editRecord : Evergreen.V389.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V389.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V389.Document.Document
    , currentCheatsheet : Maybe Evergreen.V389.Document.Document
    , currentMasterDocument : Maybe Evergreen.V389.Document.Document
    , documents : List Evergreen.V389.Document.Document
    , publicDocuments : List Evergreen.V389.Document.Document
    , inputSearchKey : String
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V389.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V389.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V389.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V389.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V389.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V389.Document.Document
    | UpdateSharedDocumentDict Evergreen.V389.Document.Document
    | GetCheatSheetDocument
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById DocumentHandling Evergreen.V389.Document.DocumentId
    | GetPublicDocuments SortMode (Maybe String)
    | SaveDocument Evergreen.V389.Document.Document
    ...
    | CreateDocument (Maybe Evergreen.V389.User.User) Evergreen.V389.Document.Document
    | ApplySpecial Evergreen.V389.User.User String
    | DeleteDocumentBE Evergreen.V389.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V389.Document.Document
    | Tick Time.Posix
...
type ToFrontend
    ...
    | UserSignedUp Evergreen.V389.User.User
    | GotChatHistory
    ...
    | ReceivedDocument DocumentHandling Evergreen.V389.Document.Document
    | ReceivedNewDocument DocumentHandling Evergreen.V389.Document.Document
    | ReceivedDocuments (List Evergreen.V389.Document.Document)
    | ReceivedPublicDocuments (List Evergreen.V389.Document.Document)
    | MessageReceived Message
    | StatusReport (List String)
    | SetShowEditor Bool
    | UnlockDocument Evergreen.V389.Document.DocumentId
