...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V378.Document.Share
...
type FrontendMsg
    ...
    | GotTime Time.Posix
    | Render Evergreen.V378.Render.Msg.MarkupMsg
    | ToggleCheatsheet
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V378.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V378.Document.Document
    | LockCurrentDocument
    ...
    | SetDocumentCurrent Evergreen.V378.Document.Document
    | SetDocumentCurrentViaId Evergreen.V378.Document.DocumentId
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V378.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent DocumentHandling Evergreen.V378.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent DocumentHandling Evergreen.V378.Document.Document
    | SetPublic Evergreen.V378.Document.Document Bool
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V378.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , currentUser : Maybe Evergreen.V378.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V378.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , sourceText : String
    , inputTitle : String
    , editRecord : Evergreen.V378.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V378.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V378.Document.Document
    , currentCheatsheet : Maybe Evergreen.V378.Document.Document
    , currentMasterDocument : Maybe Evergreen.V378.Document.Document
    , documents : List Evergreen.V378.Document.Document
    , publicDocuments : List Evergreen.V378.Document.Document
    , inputSearchKey : String
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V378.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V378.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V378.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V378.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V378.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V378.Document.Document
    | UpdateSharedDocumentDict Evergreen.V378.Document.Document
    | GetCheatSheetDocument
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById DocumentHandling Evergreen.V378.Document.DocumentId
    | GetPublicDocuments SortMode (Maybe String)
    | SaveDocument Evergreen.V378.Document.Document
    ...
    | CreateDocument (Maybe Evergreen.V378.User.User) Evergreen.V378.Document.Document
    | ApplySpecial Evergreen.V378.User.User String
    | DeleteDocumentBE Evergreen.V378.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V378.Document.Document
    | Tick Time.Posix
...
type ToFrontend
    ...
    | UserSignedUp Evergreen.V378.User.User
    | GotChatHistory
    ...
    | ReceivedDocument DocumentHandling Evergreen.V378.Document.Document
    | ReceivedNewDocument DocumentHandling Evergreen.V378.Document.Document
    | ReceivedDocuments (List Evergreen.V378.Document.Document)
    | ReceivedPublicDocuments (List Evergreen.V378.Document.Document)
    | MessageReceived Message
    | StatusReport (List String)
    | SetShowEditor Bool
    | UnlockDocument Evergreen.V378.Document.DocumentId
