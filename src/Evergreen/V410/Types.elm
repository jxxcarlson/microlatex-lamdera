module Evergreen.V410.Types exposing (..)
...
import Debounce
import Dict
import Evergreen.V410.Abstract
import Evergreen.V410.Authentication
import Evergreen.V410.Compiler.DifferentialParser
import Evergreen.V410.Document
import Evergreen.V410.Parser.Block
import Evergreen.V410.Parser.Language
import Evergreen.V410.Render.Msg
...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V410.Document.Share
...
type FrontendMsg
    ...
    | GotTime Time.Posix
    | Render Evergreen.V410.Render.Msg.MarkupMsg
    | ToggleCheatsheet
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V410.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V410.Document.Document
    | LockCurrentDocument
    ...
    | SetDocumentCurrent Evergreen.V410.Document.Document
    | SetDocumentCurrentViaId Evergreen.V410.Document.DocumentId
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V410.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent DocumentHandling Evergreen.V410.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent DocumentHandling Evergreen.V410.Document.Document
    | SetPublic Evergreen.V410.Document.Document Bool
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V410.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , currentUser : Maybe Evergreen.V410.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V410.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , sourceText : String
    , inputTitle : String
    , editRecord : Evergreen.V410.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V410.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V410.Document.Document
    , currentCheatsheet : Maybe Evergreen.V410.Document.Document
    , currentMasterDocument : Maybe Evergreen.V410.Document.Document
    , documents : List Evergreen.V410.Document.Document
    , pinnedDocuments : List Evergreen.V410.Document.Document
    , publicDocuments : List Evergreen.V410.Document.Document
    , inputSearchKey : String
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V410.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V410.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V410.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V410.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V410.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V410.Document.Document
    | UpdateSharedDocumentDict Evergreen.V410.Document.Document
    | InsertDocument Evergreen.V410.User.User Evergreen.V410.Document.Document
    | GetCheatSheetDocument
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById DocumentHandling Evergreen.V410.Document.DocumentId
    | GetPublicDocuments SortMode (Maybe String)
    | SaveDocument Evergreen.V410.Document.Document
    ...
    | CreateDocument (Maybe Evergreen.V410.User.User) Evergreen.V410.Document.Document
    | ApplySpecial Evergreen.V410.User.User String
    | DeleteDocumentBE Evergreen.V410.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V410.Document.Document
    | Tick Time.Posix
...
type ToFrontend
    ...
    | UserSignedUp Evergreen.V410.User.User
    | GotChatHistory
    ...
    | ReceivedDocument DocumentHandling Evergreen.V410.Document.Document
    | ReceivedNewDocument DocumentHandling Evergreen.V410.Document.Document
    | ReceivedDocuments DocumentHandling (List Evergreen.V410.Document.Document)
    | ReceivedPublicDocuments (List Evergreen.V410.Document.Document)
    | MessageReceived Message
    | StatusReport (List String)
    | SetShowEditor Bool
    | UnlockDocument Evergreen.V410.Document.DocumentId
