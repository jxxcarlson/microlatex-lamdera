module Evergreen.V390.Types exposing (..)
...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V390.Document.Share
...
type FrontendMsg
    ...
    | GotTime Time.Posix
    | Render Evergreen.V390.Render.Msg.MarkupMsg
    | ToggleCheatsheet
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V390.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V390.Document.Document
    | LockCurrentDocument
    ...
    | SetDocumentCurrent Evergreen.V390.Document.Document
    | SetDocumentCurrentViaId Evergreen.V390.Document.DocumentId
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V390.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent DocumentHandling Evergreen.V390.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent DocumentHandling Evergreen.V390.Document.Document
    | SetPublic Evergreen.V390.Document.Document Bool
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V390.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , currentUser : Maybe Evergreen.V390.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V390.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , sourceText : String
    , inputTitle : String
    , editRecord : Evergreen.V390.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V390.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V390.Document.Document
    , currentCheatsheet : Maybe Evergreen.V390.Document.Document
    , currentMasterDocument : Maybe Evergreen.V390.Document.Document
    , documents : List Evergreen.V390.Document.Document
    , publicDocuments : List Evergreen.V390.Document.Document
    , inputSearchKey : String
    ...
    , sortMode : SortMode
    , language : Evergreen.V390.Parser.Language.Language
    }
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V390.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V390.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V390.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V390.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V390.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V390.Document.Document
    | UpdateSharedDocumentDict Evergreen.V390.Document.Document
    | GetCheatSheetDocument
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById DocumentHandling Evergreen.V390.Document.DocumentId
    | GetPublicDocuments SortMode (Maybe String)
    | SaveDocument Evergreen.V390.Document.Document
    ...
    | CreateDocument (Maybe Evergreen.V390.User.User) Evergreen.V390.Document.Document
    | ApplySpecial Evergreen.V390.User.User String
    | DeleteDocumentBE Evergreen.V390.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V390.Document.Document
    | Tick Time.Posix
...
type ToFrontend
    ...
    | UserSignedUp Evergreen.V390.User.User
    | GotChatHistory
    ...
    | ReceivedDocument DocumentHandling Evergreen.V390.Document.Document
    | ReceivedNewDocument DocumentHandling Evergreen.V390.Document.Document
    | ReceivedDocuments (List Evergreen.V390.Document.Document)
    | ReceivedPublicDocuments (List Evergreen.V390.Document.Document)
    | MessageReceived Message
    | StatusReport (List String)
    | SetShowEditor Bool
    | UnlockDocument Evergreen.V390.Document.DocumentId
