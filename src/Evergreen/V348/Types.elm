...
import Debounce
import Dict
import Evergreen.V348.Abstract
import Evergreen.V348.Authentication
import Evergreen.V348.Compiler.DifferentialParser
import Evergreen.V348.Document
import Evergreen.V348.Parser.Block
import Evergreen.V348.Parser.Language
import Evergreen.V348.Render.Msg
...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V348.Document.Share
...
type FrontendMsg
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V348.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V348.Document.Document
    | LockCurrentDocument
    | UnLockCurrentDocument
    | ShareDocument
    | DoShare
    ...
    | SetDocumentCurrent Evergreen.V348.Document.Document
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V348.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent SystemDocPermissions Evergreen.V348.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent SystemDocPermissions Evergreen.V348.Document.Document
    | SetPublic Evergreen.V348.Document.Document Bool
    | AskForDocumentById String
    | AskForDocumentByAuthorId
    | DeleteDocument
    | SetDeleteDocumentState DocumentDeleteState
    | Render Evergreen.V348.Render.Msg.MarkupMsg
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V348.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , inputSpecial : String
    , userList : List ( Evergreen.V348.User.User, Int )
    , connectedUsers : List String
    , shareDocumentList : List ( String, SharedDocument )
    , userMessage : Maybe UserMessage
    , currentUser : Maybe Evergreen.V348.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V348.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , sourceText : String
    , inputTitle : String
    , editRecord : Evergreen.V348.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V348.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V348.Document.Document
    , currentMasterDocument : Maybe Evergreen.V348.Document.Document
    , documents : List Evergreen.V348.Document.Document
    , publicDocuments : List Evergreen.V348.Document.Document
    , inputSearchKey : String
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V348.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V348.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V348.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V348.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V348.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V348.Document.Document
    | UpdateSharedDocumentDict Evergreen.V348.Document.Document
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById String (Maybe String)
    | GetPublicDocuments SortMode (Maybe String)
    | SaveDocument Evergreen.V348.Document.Document
    | SearchForDocumentsWithAuthorAndKey String
    | SearchForDocuments (Maybe String) String
    | GetDocumentByPublicId String
    | GetDocumentById String
    | CreateDocument (Maybe Evergreen.V348.User.User) Evergreen.V348.Document.Document
    | ApplySpecial Evergreen.V348.User.User String
    | DeleteDocumentBE Evergreen.V348.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V348.Document.Document
    | Tick Time.Posix


type ToFrontend
    = SendBackupData String
    | GotUserList (List ( Evergreen.V348.User.User, Int ))
    ...
    | UserSignedUp Evergreen.V348.User.User
    | GotChatHistory
    ...
    | ReceivedDocument SystemDocPermissions Evergreen.V348.Document.Document
    | ReceivedDocuments (List Evergreen.V348.Document.Document)
    | ReceivedPublicDocuments (List Evergreen.V348.Document.Document)
