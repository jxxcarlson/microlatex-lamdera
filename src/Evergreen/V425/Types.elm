module Evergreen.V425.Types exposing (..)
...
import Debounce
import Dict
import Evergreen.V425.Abstract
import Evergreen.V425.Authentication
import Evergreen.V425.Compiler.DifferentialParser
import Evergreen.V425.Document
import Evergreen.V425.Parser.Block
import Evergreen.V425.Parser.Language
import Evergreen.V425.Render.Msg
...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V425.Document.Share
...
type FrontendMsg
    ...
    | GotTime Time.Posix
    | Render Evergreen.V425.Render.Msg.MarkupMsg
    | ToggleCheatsheet
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V425.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V425.Document.Document
    | LockCurrentDocument
    ...
    | SetDocumentCurrent Evergreen.V425.Document.Document
    | SetDocumentCurrentViaId Evergreen.V425.Document.DocumentId
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V425.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent DocumentHandling Evergreen.V425.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent DocumentHandling Evergreen.V425.Document.Document
    | SetPublic Evergreen.V425.Document.Document Bool
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V425.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , currentUser : Maybe Evergreen.V425.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V425.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , sourceText : String
    , inputTitle : String
    , editRecord : Evergreen.V425.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V425.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V425.Document.Document
    , currentCheatsheet : Maybe Evergreen.V425.Document.Document
    , currentMasterDocument : Maybe Evergreen.V425.Document.Document
    , documents : List Evergreen.V425.Document.Document
    , pinnedDocuments : List Evergreen.V425.Document.Document
    , publicDocuments : List Evergreen.V425.Document.Document
    , inputSearchKey : String
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V425.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V425.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V425.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V425.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V425.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V425.Document.Document
    | UpdateSharedDocumentDict Evergreen.V425.Document.Document
    | InsertDocument Evergreen.V425.User.User Evergreen.V425.Document.Document
    | GetCheatSheetDocument
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById DocumentHandling Evergreen.V425.Document.DocumentId
    | GetPublicDocuments SortMode (Maybe String)
    | SaveDocument Evergreen.V425.Document.Document
    ...
    | CreateDocument (Maybe Evergreen.V425.User.User) Evergreen.V425.Document.Document
    | ApplySpecial Evergreen.V425.User.User String
    | HardDeleteDocumentBE Evergreen.V425.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V425.Document.Document
    | Tick Time.Posix
...
type ToFrontend
    ...
    | UserSignedUp Evergreen.V425.User.User
    | GotChatHistory
    ...
    | ReceivedDocument DocumentHandling Evergreen.V425.Document.Document
    | ReceivedNewDocument DocumentHandling Evergreen.V425.Document.Document
    | ReceivedDocuments DocumentHandling (List Evergreen.V425.Document.Document)
    | ReceivedPublicDocuments (List Evergreen.V425.Document.Document)
    | MessageReceived Message
    | StatusReport (List String)
    | SetShowEditor Bool
    | UnlockDocument Evergreen.V425.Document.DocumentId
