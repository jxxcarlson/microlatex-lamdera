module Evergreen.V391.Types exposing (..)
...
import Debounce
import Dict
import Evergreen.V391.Abstract
import Evergreen.V391.Authentication
import Evergreen.V391.Compiler.DifferentialParser
import Evergreen.V391.Document
import Evergreen.V391.Parser.Block
import Evergreen.V391.Parser.Language
import Evergreen.V391.Render.Msg
...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V391.Document.Share
...
type FrontendMsg
    ...
    | GotTime Time.Posix
    | Render Evergreen.V391.Render.Msg.MarkupMsg
    | ToggleCheatsheet
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V391.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V391.Document.Document
    | LockCurrentDocument
    ...
    | MakeBackup
    | SetDocumentCurrent Evergreen.V391.Document.Document
    | SetDocumentCurrentViaId Evergreen.V391.Document.DocumentId
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V391.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent DocumentHandling Evergreen.V391.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent DocumentHandling Evergreen.V391.Document.Document
    | SetPublic Evergreen.V391.Document.Document Bool
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V391.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , currentUser : Maybe Evergreen.V391.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V391.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , sourceText : String
    , inputTitle : String
    , editRecord : Evergreen.V391.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V391.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V391.Document.Document
    , currentCheatsheet : Maybe Evergreen.V391.Document.Document
    , currentMasterDocument : Maybe Evergreen.V391.Document.Document
    , documents : List Evergreen.V391.Document.Document
    , publicDocuments : List Evergreen.V391.Document.Document
    , inputSearchKey : String
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V391.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V391.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V391.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V391.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V391.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V391.Document.Document
    | UpdateSharedDocumentDict Evergreen.V391.Document.Document
    | InsertDocument Evergreen.V391.Document.Document
    | GetCheatSheetDocument
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById DocumentHandling Evergreen.V391.Document.DocumentId
    | GetPublicDocuments SortMode (Maybe String)
    | SaveDocument Evergreen.V391.Document.Document
    ...
    | CreateDocument (Maybe Evergreen.V391.User.User) Evergreen.V391.Document.Document
    | ApplySpecial Evergreen.V391.User.User String
    | DeleteDocumentBE Evergreen.V391.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V391.Document.Document
    | Tick Time.Posix
...
type ToFrontend
    ...
    | UserSignedUp Evergreen.V391.User.User
    | GotChatHistory
    ...
    | ReceivedDocument DocumentHandling Evergreen.V391.Document.Document
    | ReceivedNewDocument DocumentHandling Evergreen.V391.Document.Document
    | ReceivedDocuments (List Evergreen.V391.Document.Document)
    | ReceivedPublicDocuments (List Evergreen.V391.Document.Document)
    | MessageReceived Message
    | StatusReport (List String)
    | SetShowEditor Bool
    | UnlockDocument Evergreen.V391.Document.DocumentId
