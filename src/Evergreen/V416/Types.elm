module Evergreen.V416.Types exposing (..)
...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V416.Document.Share
...
type FrontendMsg
    ...
    | GotTime Time.Posix
    | Render Evergreen.V416.Render.Msg.MarkupMsg
    | ToggleCheatsheet
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V416.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V416.Document.Document
    | LockCurrentDocument
    ...
    | SetDocumentCurrent Evergreen.V416.Document.Document
    | SetDocumentCurrentViaId Evergreen.V416.Document.DocumentId
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V416.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent DocumentHandling Evergreen.V416.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent DocumentHandling Evergreen.V416.Document.Document
    | SetPublic Evergreen.V416.Document.Document Bool
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V416.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , currentUser : Maybe Evergreen.V416.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V416.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , sourceText : String
    , inputTitle : String
    , editRecord : Evergreen.V416.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V416.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V416.Document.Document
    , currentCheatsheet : Maybe Evergreen.V416.Document.Document
    , currentMasterDocument : Maybe Evergreen.V416.Document.Document
    , documents : List Evergreen.V416.Document.Document
    , pinnedDocuments : List Evergreen.V416.Document.Document
    , publicDocuments : List Evergreen.V416.Document.Document
    , inputSearchKey : String
    ...
    , sortMode : SortMode
    , language : Evergreen.V416.Parser.Language.Language
    }
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V416.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V416.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V416.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V416.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V416.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V416.Document.Document
    | UpdateSharedDocumentDict Evergreen.V416.Document.Document
    | InsertDocument Evergreen.V416.User.User Evergreen.V416.Document.Document
    | GetCheatSheetDocument
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById DocumentHandling Evergreen.V416.Document.DocumentId
    | GetPublicDocuments SortMode (Maybe String)
    | SaveDocument Evergreen.V416.Document.Document
    ...
    | CreateDocument (Maybe Evergreen.V416.User.User) Evergreen.V416.Document.Document
    | ApplySpecial Evergreen.V416.User.User String
    | DeleteDocumentBE Evergreen.V416.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V416.Document.Document
    | Tick Time.Posix
...
type ToFrontend
    ...
    | UserSignedUp Evergreen.V416.User.User
    | GotChatHistory
    ...
    | ReceivedDocument DocumentHandling Evergreen.V416.Document.Document
    | ReceivedNewDocument DocumentHandling Evergreen.V416.Document.Document
    | ReceivedDocuments DocumentHandling (List Evergreen.V416.Document.Document)
    | ReceivedPublicDocuments (List Evergreen.V416.Document.Document)
    | MessageReceived Message
    | StatusReport (List String)
    | SetShowEditor Bool
    | UnlockDocument Evergreen.V416.Document.DocumentId
