module Evergreen.V701.User exposing (..)
...
type alias User =
    ...
    , docs : BoundedDeque.BoundedDeque Evergreen.V701.Document.DocumentInfo
    ...
    , pings : List Evergreen.V701.Chat.Message.ChatMessage
    }
