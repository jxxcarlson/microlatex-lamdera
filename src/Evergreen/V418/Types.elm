module Evergreen.V418.Types exposing (..)
...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V418.Document.Share
...
type FrontendMsg
    ...
    | GotTime Time.Posix
    | Render Evergreen.V418.Render.Msg.MarkupMsg
    | ToggleCheatsheet
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V418.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V418.Document.Document
    | LockCurrentDocument
    ...
    | SetDocumentCurrent Evergreen.V418.Document.Document
    | SetDocumentCurrentViaId Evergreen.V418.Document.DocumentId
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V418.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent DocumentHandling Evergreen.V418.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent DocumentHandling Evergreen.V418.Document.Document
    | SetPublic Evergreen.V418.Document.Document Bool
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V418.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , currentUser : Maybe Evergreen.V418.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V418.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , sourceText : String
    , inputTitle : String
    , editRecord : Evergreen.V418.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V418.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V418.Document.Document
    , currentCheatsheet : Maybe Evergreen.V418.Document.Document
    , currentMasterDocument : Maybe Evergreen.V418.Document.Document
    , documents : List Evergreen.V418.Document.Document
    , pinnedDocuments : List Evergreen.V418.Document.Document
    , publicDocuments : List Evergreen.V418.Document.Document
    , inputSearchKey : String
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V418.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V418.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V418.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V418.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V418.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V418.Document.Document
    | UpdateSharedDocumentDict Evergreen.V418.Document.Document
    | InsertDocument Evergreen.V418.User.User Evergreen.V418.Document.Document
    | GetCheatSheetDocument
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById DocumentHandling Evergreen.V418.Document.DocumentId
    | GetPublicDocuments SortMode (Maybe String)
    | SaveDocument Evergreen.V418.Document.Document
    ...
    | CreateDocument (Maybe Evergreen.V418.User.User) Evergreen.V418.Document.Document
    | ApplySpecial Evergreen.V418.User.User String
    | DeleteDocumentBE Evergreen.V418.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V418.Document.Document
    | Tick Time.Posix
...
type ToFrontend
    ...
    | UserSignedUp Evergreen.V418.User.User
    | GotChatHistory
    ...
    | ReceivedDocument DocumentHandling Evergreen.V418.Document.Document
    | ReceivedNewDocument DocumentHandling Evergreen.V418.Document.Document
    | ReceivedDocuments DocumentHandling (List Evergreen.V418.Document.Document)
    | ReceivedPublicDocuments (List Evergreen.V418.Document.Document)
    | MessageReceived Message
    | StatusReport (List String)
    | SetShowEditor Bool
    | UnlockDocument Evergreen.V418.Document.DocumentId
