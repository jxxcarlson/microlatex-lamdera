module Evergreen.V674.User exposing (..)
...
type alias User =
    ...
    , docs : BoundedDeque.BoundedDeque Evergreen.V674.Document.DocumentInfo
    ...
    , pings : List Evergreen.V674.Chat.Message.ChatMessage
    }
