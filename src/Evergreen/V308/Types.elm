...
import Debounce
import Dict
import Evergreen.V308.Abstract
import Evergreen.V308.Authentication
import Evergreen.V308.Compiler.DifferentialParser
import Evergreen.V308.Document
import Evergreen.V308.Parser.Block
import Evergreen.V308.Parser.Language
import Evergreen.V308.Render.Msg
...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V308.Document.Share
...
type FrontendMsg
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V308.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V308.Document.Document
    | LockCurrentDocument
    | UnLockCurrentDocument
    | ShareDocument
    | DoShare
    ...
    | SetDocumentCurrent Evergreen.V308.Document.Document
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V308.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent SystemDocPermissions Evergreen.V308.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent SystemDocPermissions Evergreen.V308.Document.Document
    | SetPublic Evergreen.V308.Document.Document Bool
    | AskForDocumentById String
    | AskForDocumentByAuthorId
    | DeleteDocument
    | SetDeleteDocumentState DocumentDeleteState
    | Render Evergreen.V308.Render.Msg.MarkupMsg
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V308.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , inputSpecial : String
    , userList : List ( Evergreen.V308.User.User, Int )
    , connectedUsers : List String
    , shareDocumentList : List ( String, SharedDocument )
    , userMessage : Maybe UserMessage
    , currentUser : Maybe Evergreen.V308.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V308.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , sourceText : String
    , inputTitle : String
    , editRecord : Evergreen.V308.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V308.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V308.Document.Document
    , currentMasterDocument : Maybe Evergreen.V308.Document.Document
    , documents : List Evergreen.V308.Document.Document
    , publicDocuments : List Evergreen.V308.Document.Document
    , inputSearchKey : String
    , inputSearchTagsKey : String
    , inputReaders : String
    , inputEditors : String
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V308.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V308.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V308.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V308.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V308.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V308.Document.Document
    | UpdateSharedDocumentDict Evergreen.V308.Document.Document
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById String (Maybe String)
    | GetPublicDocuments (Maybe String)
    | SaveDocument Evergreen.V308.Document.Document
    | SearchForDocumentsWithAuthorAndKey String
    | GetDocumentByPublicId String
    | GetDocumentById String
    | CreateDocument (Maybe Evergreen.V308.User.User) Evergreen.V308.Document.Document
    | ApplySpecial Evergreen.V308.User.User String
    | SearchForDocuments (Maybe String) String
    | DeleteDocumentBE Evergreen.V308.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V308.Document.Document
    | Tick Time.Posix


type ToFrontend
    = SendBackupData String
    | GotUserList (List ( Evergreen.V308.User.User, Int ))
    ...
    | UserSignedUp Evergreen.V308.User.User
    | GotChatHistory
    ...
    | SendDocument SystemDocPermissions Evergreen.V308.Document.Document
    | ReceivedDocuments (List Evergreen.V308.Document.Document)
    | ReceivedPublicDocuments (List Evergreen.V308.Document.Document)
    | SendMessage Message
    | StatusReport (List String)
    | SetShowEditor Bool
