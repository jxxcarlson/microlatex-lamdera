...
import Evergreen.V81.Compiler.DifferentialParser
...
type alias FrontendModel =
    ...
    , initialText : String
    , sourceText : String
    , editRecord : Evergreen.V81.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List (Evergreen.V81.Parser.Block.ExpressionBlock Evergreen.V81.Parser.Expr.Expr)
    , title : String
    , searchCount : Int
...
type ToBackend
    ...
    | ApplySpecial Evergreen.V81.User.User String
