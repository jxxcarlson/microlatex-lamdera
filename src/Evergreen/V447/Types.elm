module Evergreen.V447.Types exposing (..)
...
import Debounce
import Dict
import Evergreen.V447.Abstract
import Evergreen.V447.Authentication
import Evergreen.V447.Compiler.DifferentialParser
import Evergreen.V447.Document
import Evergreen.V447.Parser.Block
import Evergreen.V447.Parser.Language
import Evergreen.V447.Render.Msg
...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V447.Document.Share
...
type FrontendMsg
    ...
    | GotTime Time.Posix
    | Render Evergreen.V447.Render.Msg.MarkupMsg
    | ToggleCheatsheet
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V447.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V447.Document.Document
    | LockCurrentDocument
    ...
    | SetDocumentStatus Evergreen.V447.Document.DocStatus
    | ChangeLanguage
    | MakeBackup
    | ToggleBackupVisibility
    | SetDocumentCurrent Evergreen.V447.Document.Document
    | SetDocumentCurrentViaId Evergreen.V447.Document.DocumentId
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V447.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent DocumentHandling Evergreen.V447.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent DocumentHandling Evergreen.V447.Document.Document
    | SetPublic Evergreen.V447.Document.Document Bool
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V447.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , currentUser : Maybe Evergreen.V447.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V447.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , inputTitle : String
    , showDocTools : Bool
    , editRecord : Evergreen.V447.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V447.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V447.Document.Document
    , currentCheatsheet : Maybe Evergreen.V447.Document.Document
    , currentMasterDocument : Maybe Evergreen.V447.Document.Document
    , documents : List Evergreen.V447.Document.Document
    , pinnedDocuments : List Evergreen.V447.Document.DocumentInfo
    , publicDocuments : List Evergreen.V447.Document.Document
    , inputSearchKey : String
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V447.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V447.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V447.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V447.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V447.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V447.Document.Document
    | UpdateSharedDocumentDict Evergreen.V447.Document.Document
    | InsertDocument Evergreen.V447.User.User Evergreen.V447.Document.Document
    | GetCheatSheetDocument
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById DocumentHandling Evergreen.V447.Document.DocumentId
    | GetPublicDocuments SortMode (Maybe String)
    | SaveDocument Evergreen.V447.Document.Document
    ...
    | CreateDocument (Maybe Evergreen.V447.User.User) Evergreen.V447.Document.Document
    | ApplySpecial Evergreen.V447.User.User String
    | HardDeleteDocumentBE Evergreen.V447.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V447.Document.Document
    | Tick Time.Posix
...
type ToFrontend
    ...
    | UserSignedUp Evergreen.V447.User.User
    | GotChatHistory
    ...
    | ReceivedDocument DocumentHandling Evergreen.V447.Document.Document
    | ReceivedNewDocument DocumentHandling Evergreen.V447.Document.Document
    | ReceivedDocuments DocumentHandling (List Evergreen.V447.Document.Document)
    | ReceivedPublicDocuments (List Evergreen.V447.Document.Document)
    | MessageReceived Message
    | StatusReport (List String)
    | SetShowEditor Bool
    | UnlockDocument Evergreen.V447.Document.DocumentId
