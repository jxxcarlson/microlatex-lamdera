module Evergreen.V477.Types exposing (..)
...
import Debounce
import Dict
import Evergreen.V477.Abstract
import Evergreen.V477.Authentication
import Evergreen.V477.Compiler.DifferentialParser
import Evergreen.V477.Document
import Evergreen.V477.Parser.Block
import Evergreen.V477.Parser.Language
import Evergreen.V477.Render.Msg
...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V477.Document.Share
...
type FrontendMsg
    ...
    | GotTime Time.Posix
    | Render Evergreen.V477.Render.Msg.MarkupMsg
    | ToggleCheatsheet
    | ToggleManuals
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V477.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V477.Document.Document
    | LockCurrentDocument
    ...
    | SetDocumentStatus Evergreen.V477.Document.DocStatus
    | ChangeLanguage
    | MakeBackup
    | ToggleBackupVisibility
    | SetDocumentCurrent Evergreen.V477.Document.Document
    | SetDocumentCurrentViaId Evergreen.V477.Document.DocumentId
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V477.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent DocumentHandling Evergreen.V477.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent DocumentHandling Evergreen.V477.Document.Document
    | SetPublic Evergreen.V477.Document.Document Bool
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V477.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , currentUser : Maybe Evergreen.V477.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V477.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , showDocTools : Bool
    , showPublicUrl : Bool
    , editRecord : Evergreen.V477.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V477.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V477.Document.Document
    , currentCheatsheet : Maybe Evergreen.V477.Document.Document
    , currentMasterDocument : Maybe Evergreen.V477.Document.Document
    , documents : List Evergreen.V477.Document.Document
    , pinnedDocuments : List Evergreen.V477.Document.DocumentInfo
    , publicDocuments : List Evergreen.V477.Document.Document
    , inputSearchKey : String
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V477.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V477.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V477.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V477.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V477.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V477.Document.Document
    | UpdateSharedDocumentDict Evergreen.V477.Document.Document
    | InsertDocument Evergreen.V477.User.User Evergreen.V477.Document.Document
    | GetCheatSheetDocument
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById DocumentHandling Evergreen.V477.Document.DocumentId
    | FindDocumentByAuthorAndKey DocumentHandling Username String
    | GetPublicDocuments SortMode (Maybe String)
    | SaveDocument Evergreen.V477.Document.Document
    ...
    | CreateDocument (Maybe Evergreen.V477.User.User) Evergreen.V477.Document.Document
    | ApplySpecial Evergreen.V477.User.User String
    | HardDeleteDocumentBE Evergreen.V477.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V477.Document.Document
    | Tick Time.Posix
...
type ToFrontend
    ...
    | UserSignedUp Evergreen.V477.User.User
    | GotChatHistory
    ...
    | ReceivedDocument DocumentHandling Evergreen.V477.Document.Document
    | ReceivedNewDocument DocumentHandling Evergreen.V477.Document.Document
    | ReceivedDocuments DocumentHandling (List Evergreen.V477.Document.Document)
    | ReceivedPublicDocuments (List Evergreen.V477.Document.Document)
    | MessageReceived Message
    | StatusReport (List String)
    | SetShowEditor Bool
    | UnlockDocument Evergreen.V477.Document.DocumentId
