module Evergreen.V684.User exposing (..)
...
type alias User =
    ...
    , docs : BoundedDeque.BoundedDeque Evergreen.V684.Document.DocumentInfo
    ...
    , pings : List Evergreen.V684.Chat.Message.ChatMessage
    }
