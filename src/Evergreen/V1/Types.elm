...
import Evergreen.V1.Compiler.DifferentialParser
...
type alias FrontendModel =
    ...
    , initialText : String
    , sourceText : String
    , ast : Evergreen.V1.L0.SyntaxTree
    , editRecord : Evergreen.V1.Compiler.DifferentialParser.EditRecord (Tree.Tree Evergreen.V1.Parser.Block.IntermediateBlock) (Tree.Tree Evergreen.V1.Parser.Block.ExpressionBlock)
    , tableOfContents : List Evergreen.V1.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
...
type FrontendMsg
    ...
    | SetDocumentInPhoneAsCurrent DocPermissions Evergreen.V1.Document.Document
    | ShowTOCInPhone
    ...
    | Render Evergreen.V1.Render.Msg.L0Msg
...
type ToBackend
    ...
    | ApplySpecial Evergreen.V1.User.User String
