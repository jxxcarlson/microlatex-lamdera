...
import Evergreen.V55.Compiler.DifferentialParser
...
type alias FrontendModel =
    ...
    , initialText : String
    , sourceText : String
    , editRecord : Evergreen.V55.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List (Evergreen.V55.Parser.Block.ExpressionBlock Evergreen.V55.Parser.Expr.Expr)
    , title : String
    , searchCount : Int
...
type FrontendMsg
    ...
    | SetDocumentInPhoneAsCurrent DocPermissions Evergreen.V55.Document.Document
    | ShowTOCInPhone
...
type ToBackend
    ...
    | ApplySpecial Evergreen.V55.User.User String
