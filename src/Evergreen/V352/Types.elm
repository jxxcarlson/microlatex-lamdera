...
import Debounce
import Dict
import Evergreen.V352.Abstract
import Evergreen.V352.Authentication
import Evergreen.V352.Compiler.DifferentialParser
import Evergreen.V352.Document
import Evergreen.V352.Parser.Block
import Evergreen.V352.Parser.Language
import Evergreen.V352.Render.Msg
...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V352.Document.Share
...
type FrontendMsg
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V352.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V352.Document.Document
    | LockCurrentDocument
    | ShareDocument
    | DoShare
    ...
    | SetDocumentCurrent Evergreen.V352.Document.Document
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V352.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent SystemDocPermissions Evergreen.V352.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent SystemDocPermissions Evergreen.V352.Document.Document
    | SetPublic Evergreen.V352.Document.Document Bool
    | AskForDocumentById String
    | AskForDocumentByAuthorId
    | DeleteDocument
    | SetDeleteDocumentState DocumentDeleteState
    | Render Evergreen.V352.Render.Msg.MarkupMsg
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V352.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , inputSpecial : String
    , userList : List ( Evergreen.V352.User.User, Int )
    , connectedUsers : List String
    , shareDocumentList : List ( String, SharedDocument )
    , userMessage : Maybe UserMessage
    , currentUser : Maybe Evergreen.V352.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V352.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , sourceText : String
    , inputTitle : String
    , editRecord : Evergreen.V352.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V352.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V352.Document.Document
    , currentMasterDocument : Maybe Evergreen.V352.Document.Document
    , documents : List Evergreen.V352.Document.Document
    , publicDocuments : List Evergreen.V352.Document.Document
    , inputSearchKey : String
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V352.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V352.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V352.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V352.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V352.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V352.Document.Document
    | UpdateSharedDocumentDict Evergreen.V352.Document.Document
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById String (Maybe String)
    | GetPublicDocuments SortMode (Maybe String)
    | SaveDocument Evergreen.V352.Document.Document
    | SearchForDocumentsWithAuthorAndKey String
    | SearchForDocuments (Maybe String) String
    | GetDocumentByPublicId String
    | GetDocumentById String
    | CreateDocument (Maybe Evergreen.V352.User.User) Evergreen.V352.Document.Document
    | ApplySpecial Evergreen.V352.User.User String
    | DeleteDocumentBE Evergreen.V352.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V352.Document.Document
    | Tick Time.Posix


type ToFrontend
    = SendBackupData String
    | GotUserList (List ( Evergreen.V352.User.User, Int ))
    ...
    | UserSignedUp Evergreen.V352.User.User
    | GotChatHistory
    ...
    | ReceivedDocument SystemDocPermissions Evergreen.V352.Document.Document
    | ReceivedNewDocument SystemDocPermissions Evergreen.V352.Document.Document
    | ReceivedDocuments (List Evergreen.V352.Document.Document)
    | ReceivedPublicDocuments (List Evergreen.V352.Document.Document)
