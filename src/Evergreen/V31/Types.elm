...
import Evergreen.V31.Compiler.DifferentialParser
...
type alias FrontendModel =
    ...
    , initialText : String
    , sourceText : String
    , editRecord : Evergreen.V31.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List (Evergreen.V31.Parser.Block.ExpressionBlock Evergreen.V31.Parser.Expr.Expr)
    , title : String
    , searchCount : Int
...
type FrontendMsg
    ...
    | SetDocumentInPhoneAsCurrent DocPermissions Evergreen.V31.Document.Document
    | ShowTOCInPhone
    ...
    | Render Evergreen.V31.Render.Msg.L0Msg
...
type ToBackend
    ...
    | ApplySpecial Evergreen.V31.User.User String
