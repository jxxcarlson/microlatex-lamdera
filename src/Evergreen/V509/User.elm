module Evergreen.V509.User exposing (..)
...
type alias User =
    ...
    , created : Time.Posix
    , modified : Time.Posix
    , docs : BoundedDeque.BoundedDeque Evergreen.V509.Document.DocumentInfo
    ...
    , pings : List Evergreen.V509.Chat.Message.ChatMessage
    }
