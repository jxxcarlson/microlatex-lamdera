module Evergreen.V487.Types exposing (..)
...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V487.Document.Share
...
type FrontendMsg
    ...
    | GotTime Time.Posix
    | Render Evergreen.V487.Render.Msg.MarkupMsg
    | ToggleCheatsheet
    | ToggleManuals
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V487.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V487.Document.Document
    | LockCurrentDocument
    ...
    | SetDocumentStatus Evergreen.V487.Document.DocStatus
    | ChangeLanguage
    | MakeBackup
    | ToggleBackupVisibility
    | SetDocumentCurrent Evergreen.V487.Document.Document
    | SetDocumentCurrentViaId Evergreen.V487.Document.DocumentId
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V487.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent DocumentHandling Evergreen.V487.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent DocumentHandling Evergreen.V487.Document.Document
    | SetPublic Evergreen.V487.Document.Document Bool
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V487.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , currentUser : Maybe Evergreen.V487.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V487.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , showDocTools : Bool
    , showPublicUrl : Bool
    , editRecord : Evergreen.V487.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V487.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V487.Document.Document
    , currentCheatsheet : Maybe Evergreen.V487.Document.Document
    , currentMasterDocument : Maybe Evergreen.V487.Document.Document
    , documents : List Evergreen.V487.Document.Document
    , pinnedDocuments : List Evergreen.V487.Document.DocumentInfo
    , publicDocuments : List Evergreen.V487.Document.Document
    , inputSearchKey : String
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V487.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V487.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V487.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V487.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V487.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V487.Document.Document
    | UpdateSharedDocumentDict Evergreen.V487.Document.Document
    | InsertDocument Evergreen.V487.User.User Evergreen.V487.Document.Document
    | GetCheatSheetDocument
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById DocumentHandling Evergreen.V487.Document.DocumentId
    | FindDocumentByAuthorAndKey DocumentHandling Username String
    | GetPublicDocuments SortMode (Maybe String)
    | SaveDocument Evergreen.V487.Document.Document
    ...
    | CreateDocument (Maybe Evergreen.V487.User.User) Evergreen.V487.Document.Document
    | ApplySpecial Evergreen.V487.User.User String
    | HardDeleteDocumentBE Evergreen.V487.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V487.Document.Document
    | Tick Time.Posix
...
type ToFrontend
    ...
    | UserSignedUp Evergreen.V487.User.User
    | GotChatHistory
    ...
    | ReceivedDocument DocumentHandling Evergreen.V487.Document.Document
    | ReceivedNewDocument DocumentHandling Evergreen.V487.Document.Document
    | ReceivedDocuments DocumentHandling (List Evergreen.V487.Document.Document)
    | ReceivedPublicDocuments (List Evergreen.V487.Document.Document)
    | MessageReceived Message
    | StatusReport (List String)
    | SetShowEditor Bool
    | UnlockDocument Evergreen.V487.Document.DocumentId
