module Evergreen.V400.Types exposing (..)
...
import Debounce
import Dict
import Evergreen.V400.Abstract
import Evergreen.V400.Authentication
import Evergreen.V400.Compiler.DifferentialParser
import Evergreen.V400.Document
import Evergreen.V400.Parser.Block
import Evergreen.V400.Parser.Language
import Evergreen.V400.Render.Msg
...
type alias SharedDocument =
    ...
    , id : String
    , author : Maybe String
    , share : Evergreen.V400.Document.Share
...
type FrontendMsg
    ...
    | GotTime Time.Posix
    | Render Evergreen.V400.Render.Msg.MarkupMsg
    | ToggleCheatsheet
    ...
    | InputEmail String
    | SetUserLanguage Evergreen.V400.Parser.Language.Language
    | SelectedText String
    | SyncLR
    | StartSync
    | NextSync
    ...
    | DismissUserMessage
    | Narrow String Evergreen.V400.Document.Document
    | LockCurrentDocument
    ...
    | ChangeLanguage
    | MakeBackup
    | SetDocumentCurrent Evergreen.V400.Document.Document
    | SetDocumentCurrentViaId Evergreen.V400.Document.DocumentId
    | GetPinnedDocuments
    | SetLanguage Bool Evergreen.V400.Parser.Language.Language
    | Fetch String
    | SetPublicDocumentAsCurrentById String
    | SetInitialEditorContent
    | SetDocumentInPhoneAsCurrent DocumentHandling Evergreen.V400.Document.Document
    | ShowTOCInPhone
    ...
    | NewDocument
    | SetDocumentAsCurrent DocumentHandling Evergreen.V400.Document.Document
    | SetPublic Evergreen.V400.Document.Document Bool
    ...
    | ExportToMarkdown
    | ExportToLaTeX
    | ExportTo Evergreen.V400.Parser.Language.Language
    | Export
    | PrintToPDF
...
type alias FrontendModel =
    ...
    , currentUser : Maybe Evergreen.V400.User.User
    , inputUsername : String
    , inputPassword : String
    , inputPasswordAgain : String
    , inputRealname : String
    , inputEmail : String
    , inputLanguage : Evergreen.V400.Parser.Language.Language
    , tagDict :
        Dict.Dict
            String
            (List
    ...
    , sourceText : String
    , inputTitle : String
    , editRecord : Evergreen.V400.Compiler.DifferentialParser.EditRecord
    , tableOfContents : List Evergreen.V400.Parser.Block.ExpressionBlock
    , title : String
    , searchCount : Int
    ...
    , currentDocument : Maybe Evergreen.V400.Document.Document
    , currentCheatsheet : Maybe Evergreen.V400.Document.Document
    , currentMasterDocument : Maybe Evergreen.V400.Document.Document
    , documents : List Evergreen.V400.Document.Document
    , publicDocuments : List Evergreen.V400.Document.Document
    , inputSearchKey : String
...
type alias DocumentDict =
    Dict.Dict String Evergreen.V400.Document.Document
...
type alias AbstractDict =
    Dict.Dict String Evergreen.V400.Abstract.Abstract
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V400.Authentication.AuthenticationDict
...
type ToBackend
    ...
    | SignUpBE String Evergreen.V400.Parser.Language.Language String String String
    | UpdateUserWith Evergreen.V400.User.User
    | ClearChatHistory String
    | SendChatHistory String
    | InsertChatGroup ChatGroup
    | GetChatGroup String
    | ChatMsgSubmitted ChatMessage
    | Narrowcast String Evergreen.V400.Document.Document
    | UpdateSharedDocumentDict Evergreen.V400.Document.Document
    | InsertDocument Evergreen.V400.User.User Evergreen.V400.Document.Document
    | GetCheatSheetDocument
    | RequestRefresh String
    | SignOutBE (Maybe String)
    | GetHomePage String
    | FetchDocumentById DocumentHandling Evergreen.V400.Document.DocumentId
    | GetPublicDocuments SortMode (Maybe String)
    | SaveDocument Evergreen.V400.Document.Document
    ...
    | CreateDocument (Maybe Evergreen.V400.User.User) Evergreen.V400.Document.Document
    | ApplySpecial Evergreen.V400.User.User String
    | DeleteDocumentBE Evergreen.V400.Document.Document
...
type BackendMsg
    ...
    | DelaySendingDocument Lamdera.ClientId Evergreen.V400.Document.Document
    | Tick Time.Posix
...
type ToFrontend
    ...
    | UserSignedUp Evergreen.V400.User.User
    | GotChatHistory
    ...
    | ReceivedDocument DocumentHandling Evergreen.V400.Document.Document
    | ReceivedNewDocument DocumentHandling Evergreen.V400.Document.Document
    | ReceivedDocuments (List Evergreen.V400.Document.Document)
    | ReceivedPublicDocuments (List Evergreen.V400.Document.Document)
    | MessageReceived Message
    | StatusReport (List String)
    | SetShowEditor Bool
    | UnlockDocument Evergreen.V400.Document.DocumentId
